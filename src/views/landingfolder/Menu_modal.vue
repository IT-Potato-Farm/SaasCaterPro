...
<template>
    ...
    <div v-if="props.showModal" 
        class="fixed inset-0 flex items-center justify-center backdrop-blur-xs z-50"
        ...
        <div class="relative p-4 w-full max-w-4xl bg-white bg-opacity-90 rounded-lg shadow-lg dark:bg-gray-700 dark:bg-opacity-90 ">
            ...
            <div class="flex justify-between p-4 border-b dark:border-gray-600">
                ...
                <button @click="emit('closeModal')" class="text-gray-400 hover:bg-gray-200 rounded-lg w-8 h-8 dark:hover:bg-gray-600 flex justify-center items-center cursor-pointer">
            ...
            <div class="flex gap-6 p-4">
                <div class="w-1/2">
                    <img src="/assets/food1.jpg" class="w-full rounded-lg">
                </div> 
                <div class="w-1/2">
