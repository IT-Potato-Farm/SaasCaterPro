            ...
            <div class="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-gray-600">What our customers say about us</p>
                    </div>
                    <div class="mt-4 md:mt-0">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Based on {{ $reviews->count() }} reviews</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <main class="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                <div class="flex flex-col items-center sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex-1">
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="text" name="search" id="search"
                                class="focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 pr-12 py-2 border-gray-300 rounded-md"
                    ...
                    <button id="refresh-filters"
                        class=" items-center bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none">
                        Reset Filters
                    </button>
                </div>
            </div>
            ...
            <div id="reviews-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($reviews as $review)
                    <div class="review-card bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300"
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between">
                                <div class="flex items-center">
                                    ...
                                    @endif
                                    <div class="ml-3">
                                        <p class="user-name text-sm font-medium text-gray-900">
                        ...
                        <!-- Review Content -->
                        <div class="px-6 pb-4">
                            <p class="review-text text-gray-700 mb-4">{{ $review->review }}</p>
                            ...
                            @if ($review->image)
                                <div class="mt-3">
                                    <img src="{{ asset('storage/reviews/' . $review->image) }}" alt="Review image"
                                        ...
                                        onclick="openImageModal('{{ asset('storage/reviews/' . $review->image) }}')">
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
                            <div class="flex items-center justify-between text-sm text-gray-500">
                                ...
                                <button class="text-primary-600 hover:text-primary-800 flex items-center">
            ...
            @if ($reviews->isEmpty())
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500">Be the first to leave a review after your purchase!</p>
                </div>
            @endif
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-2">
                                <img id="modal-image" src="{{ asset('storage/reviews/' . $review->image) }}"
                                    alt="Full size review image" class="w-full h-auto max-h-[70vh] object-contain">
                            </div>
                        </div>
                    </div>
                </div>
