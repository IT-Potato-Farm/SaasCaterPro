                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            ...
                            <input type="text" name="first_name" id="first_name" value="{{ old('first_name') }}"
                                class="w-full px-3 py-2.5 text-sm border border-surface-200 rounded-lg form-input transition duration-150 ease-in-out @error('first_name') border-red-500 @enderror"
                                required>
                            @error('first_name')
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="last_name" id="last_name" value="{{ old('last_name') }}"
                                class="w-full px-3 py-2.5 text-sm border border-surface-200 rounded-lg form-input transition duration-150 ease-in-out @error('last_name') border-red-500 @enderror"
                                required>
                            @error('last_name')
                            <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}"
                            class="w-full px-3 py-2.5 text-sm border border-surface-200 rounded-lg form-input transition duration-150 ease-in-out @error('email') border-red-500 @enderror"
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="password"
                                class="w-full px-3 py-2.5 text-sm border border-surface-200 rounded-lg form-input transition duration-150 ease-in-out pr-10 @error('password') border-red-500 @enderror"
                                placeholder="••••••••"
                                required>
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            <input type="password" name="password_confirmation" id="password_confirmation"
                                class="w-full px-3 py-2.5 text-sm border border-surface-200 rounded-lg form-input transition duration-150 ease-in-out pr-10 @error('password_confirmation') border-red-500 @enderror"
                                placeholder="••••••••"
                                required>
                            <span class="absolute inset-y-0 right-3 flex items-center cursor-pointer"
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="tel" name="mobile" id="mobile" value="{{ old('mobile') }}"
                            class="w-full px-3 py-2.5 text-sm border border-surface-200 rounded-lg form-input transition duration-150 ease-in-out @error('mobile') border-red-500 @enderror"
