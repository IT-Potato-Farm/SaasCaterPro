...
<section class="flex pt-4 mt-30 flex-col items-center justify-center text-center bg-white mx-24">
    <div class="max-w-3/4">
        <h2 class="text-4xl font-extrabold text-gray-900 mb-6">{{$choose->title ?? 'WHY CHOOSE US'}}</h2>
        ...
        <p class="text-lg text-gray-700 leading-relaxed">
            {{$choose ->description ?? 'We are more than just your typical catering company at Saas. We are committed to turning your visions into reality.
