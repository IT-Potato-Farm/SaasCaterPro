            ...
            <form id="loginForm" action="{{ route('user.login') }}" class="space-y-4" method="post" novalidate>
                ...
                <div class="space-y-1">
                    ...
                    <input type="email" name="loginemail" id="loginemail"
                        class="w-full px-3 py-2.5 text-sm border border-surface-200 rounded-lg form-input transition duration-150 ease-in-out @error('loginemail') border-red-500 @enderror"
                ...
                <div class="space-y-1">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('password.request') }}" class="text-xs text-primary-600 hover:underline">Forgot password?</a>
                    </div>
                    <div class="relative">
                        <input type="password" name="loginpassword" id="loginpassword" 
                            class="w-full px-3 py-2.5 text-sm border border-surface-200 rounded-lg form-input transition duration-150 ease-in-out pr-10 @error('loginpassword') border-red-500 @enderror"
                            placeholder="••••••••"
