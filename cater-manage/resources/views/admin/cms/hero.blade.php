        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                ...
                <div class="mt-5">
                        ...
                        <div class="bg-white shadow-md rounded-lg p-6 mb-6">
                            <form id="editForm" action="{{ route('admin.hero.update', $heroSection->id) }}"
                                ...
                                <div id="success-message"
                                    class="hidden mt-4 p-4 bg-green-100 text-green-700 rounded-md">
                                ...
                                <div class="space-y-2">
                                    <label for="background_image"
                                        class="block text-sm font-medium text-gray-700">Background Image</label>
                                    <div class="flex items-center">
                                        ...
                                        @else
                                            <div
                                                class="w-32 h-32 bg-gray-200 rounded-md flex items-center justify-center mr-4">
                                        ...
                                        <div>
                                            <label
                                                class="cursor-pointer inline-flex items-center px-4 py-2 bg-blue-500 text-white font-medium rounded-md hover:bg-blue-600 transition">
                    ...
                    @else
                        <div class="bg-white shadow-md rounded-lg p-6 mb-6">
                            <p class="text-gray-700">No Hero section content available.</p>
                        </div>
                    @endif
                </div>
            </main>
