        ...
        <ul class="space-y-2">
            ...
            <li class="relative">
                ...
                <ul id="cmsDropdown" class="ml-8 mt-2 space-y-2 hidden">
                    ...
                    <li>
                        <a href="{{route('admin.footer.index')}}" class="block p-2 text-white rounded hover:bg-gray-700 {{ Request::routeIs('admin.footer.index') ? 'bg-gray-900' : '' }}">
                            Footer
                        </a>
                    </li>
                    <li>
                        <a href="{{route('admin.privacy.index')}}" class="block p-2 text-white rounded hover:bg-gray-700 {{ Request::routeIs('admin.privacy.index') ? 'bg-gray-900' : '' }}">
                            Privacy & Policy
                        </a>
                    </li>
                </ul>
            ...
            <li>
                <a href="{{ route('admin.settingdashboard') }}"
                    class="flex items-center p-3 hover:bg-gray-700 rounded-md {{ Request::routeIs('admin.settingdashboard') ? 'bg-gray-900' : '' }}">
                    <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
                    <span class="menu-text">Set Booking settings</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ route('admin.products') }}"
                    ...
                    <span class="menu-text">Party Trays</span>
                </a>
            </li>
            <li>
