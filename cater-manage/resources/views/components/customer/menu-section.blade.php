<section id="menu" class="menu-section h-screen">
    ...
    <div class="showallholder flex justify-center mt-3">
        <a href="{{url('/all-menus')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-3.5 inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Show All
        </a>
    </div>
</section>
