...
<section id="menu" class="menu-section py-16 ">
    ...
    <h2
    class="text-center font-extrabold text-4xl md:text-5xl mb-12 px-4 py-2"
   ...
   class="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-md hover:opacity-90 transition-colors duration-300 shadow-lg"
