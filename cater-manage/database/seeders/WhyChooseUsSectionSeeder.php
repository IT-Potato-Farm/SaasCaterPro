...
class WhyChooseUsSectionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        WhyChooseUsSection::create([
            'title' => 'WHY CHOOSE US',
            'subtitle' => 'The all-in-one solution for effortless order tracking and customer engagement services in Zamboanga City',
            'description' => 'We are more than just your typical catering company at Saas. We are committed to turning your visions into reality.
